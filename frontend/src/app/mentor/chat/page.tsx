...
export default function MentorChatPage() {
    ...
    const formatTime = (dateString?: string) => {
        ...
        if (diffInSeconds < 3600)
            return `${Math.floor(diffInSeconds / 60)}m lalu`;
                    ...
                    {chats.length === 0 && (
                        <div className="text-center py-16 bg-white rounded-3xl border border-dashed border-gray-200">
                            ...
                            <p className="text-gray-500 max-w-sm mx-auto text-sm">
                                Belum ada siswa yang memulai percakapan. Pesan
                            ...
                            {chats.map((chat) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`group relative bg-white rounded-xl p-4 border transition-all duration-200 cursor-pointer hover:shadow-md flex items-start gap-4 ${
                                            hasUnread
