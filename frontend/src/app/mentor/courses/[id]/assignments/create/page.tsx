        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Buat Assignment Baru</h1>
                <p className="text-gray-600">Tambahkan tugas atau kuis untuk siswa.</p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label className={`cursor-pointer border-2 rounded-xl p-4 flex items-center gap-3 transition-all ${assignmentType === 'tugas' ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-gray-300'
                      }`}>
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className={`p-2 rounded-full ${assignmentType === 'tugas' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-500'}`}>
                        <FileText className="w-5 h-5" />
                      </div>
                      <div>
                        <span className="font-bold text-gray-900 block">Tugas (File/Text)</span>
                        <span className="text-xs text-gray-500">Siswa mengupload file atau teks</span>
                      </div>
                      {assignmentType === 'tugas' && <CheckCircle2 className="w-5 h-5 text-primary ml-auto" />}
                    </label>

                    <label className={`cursor-pointer border-2 rounded-xl p-4 flex items-center gap-3 transition-all ${assignmentType === 'kuis' ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-gray-300'
                      }`}>
                      <input
                        {...register('type', { required: 'Tipe wajib diisi' })}
                        type="radio"
                        ...
                        className="sr-only"
                      />
                      <div className={`p-2 rounded-full ${assignmentType === 'kuis' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-500'}`}>
                        <Target className="w-5 h-5" />
                      </div>
                      <div>
                        <span className="font-bold text-gray-900 block">Kuis (Pilihan Ganda)</span>
                        <span className="text-xs text-gray-500">Pertanyaan dengan opsi jawaban</span>
                      </div>
                      {assignmentType === 'kuis' && <CheckCircle2 className="w-5 h-5 text-primary ml-auto" />}
                    </label>
                  </div>
                  {errors.type && (
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                <div className="flex items-center justify-between mb-6 border-b border-gray-100 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">{questions.length} pertanyaan ditambahkan</p>
                    </div>
                  </div>
                  <button
                    type="button"
                ...
                {questions.length === 0 && (
                  <div className="text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                    ...
                    <p className="text-sm text-gray-500 mt-1 mb-4">Mulai tambahkan soal untuk kuis ini</p>
                    <button
                      type="button"
                      onClick={addQuestion}
