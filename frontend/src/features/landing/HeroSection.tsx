...
export default function HeroSection() {
  ...
  const parallaxX = useTransform(
    mouseX,
    [0, windowSize.width || 1000],
    [-1, 1],
  );
  const parallaxY = useTransform(
    mouseY,
    [0, windowSize.height || 1000],
    [-1, 1],
  );
  ...
  if (!mounted) {
    return (
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-[#FDF8F3] via-[#FFF8E7] to-[#FDF8F3]">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10 py-20 "></div>
      </section>
    );
  }
    ...
    <section className="relative overflow-x-hidden bg-gradient-to-b from-[#FDF8F3] via-[#FFF8E7] to-[#FFF8E7]">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <motion.div
          ...
          style={{
            ...
            translateY: "-50%",
            background:
              "radial-gradient(circle at center, rgba(249, 168, 37, 0.4) 0%, transparent 70%)",
            filter: "blur(60px)",
        ...
        <motion.div
          ...
          style={{
            ...
            translateY: "-50%",
            background:
              "radial-gradient(circle at center, rgba(253, 224, 166, 0.5) 0%, transparent 70%)",
            filter: "blur(80px)",
            willChange: "transform",
          }}
        />
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <motion.div
          ...
          style={{ x: parallaxX40, y: parallaxY40, willChange: "transform" }}
        >
        ...
        <motion.div
          ...
          style={{ x: parallaxX30, y: parallaxY30, willChange: "transform" }}
        >
          <div className="w-full h-full opacity-30 animate-pulse-slow">
            <div
              className="w-full h-full"
        ...
        <motion.div
          ...
          style={{ x: parallaxX50, y: parallaxY50, willChange: "transform" }}
        >
          <div className="w-full h-full animate-spin-slow">
            <div
              className="w-full h-full rounded-full border-[4px] border-orange-200/60 dashed"
        ...
        <motion.div
          className="absolute top-[18%] right-[13%] w-[220px] h-[220px]"
          style={{ x: parallaxX70, y: parallaxY70, willChange: "transform" }}
        >
          <div className="w-full h-full animate-spin-reverse">
            <div
              className="w-full h-full rounded-full border-[3px] border-yellow-300/60"
              style={{ filter: "blur(1px)" }}
            />
          </div>
        </motion.div>
        ...
        <motion.div
          className="absolute bottom-[20%] left-[8%] w-[250px] h-[250px]"
          style={{ x: parallaxX40, y: parallaxY40, willChange: "transform" }}
        >
          <div className="w-full h-full animate-spin-slow-alt">
            <div
              className="w-full h-full rounded-full border-[4px] border-orange-300/50"
              style={{ filter: "blur(1px)" }}
            />
          </div>
        </motion.div>
        ...
        <motion.div
          className="absolute top-[30%] left-[10%] w-48 h-48"
          style={{ x: parallaxX60, y: parallaxY60, willChange: "transform" }}
        >
          <div
            className="w-full h-full rounded-full opacity-60 animate-float-1"
            style={{
              background:
        ...
        <motion.div
          className="absolute top-[50%] right-[8%] w-56 h-56"
          style={{ x: parallaxX90, y: parallaxY90, willChange: "transform" }}
        >
          <div
            className="w-full h-full rounded-full opacity-60 animate-float-2"
            style={{
              background:
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10 min-h-screen flex items-center pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Platform ekosistem IT terlengkap. Mulai dari belajar coding dengan
            gamifikasi, jasa pembuatan sistem profesional, hingga event &
            komunitas teknologi yang aktif berbagi ilmu.
          </motion.p>
      ...
      <div
        id="programs"
        className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10 pb-20"
      >
        <motion.div
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-100 text-sm font-medium text-orange-600 mb-4">
            Program Kami
          </span>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Solusi Lengkap untuk{" "}
            <span className="bg-gradient-to-r from-[#F9A825] to-[#F97316] bg-clip-text text-transparent">
              Karir IT
            </span>{" "}
            Kamu
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Dari belajar coding, jasa development, hingga event & komunitas -
            semua ada di Codelab.
          </p>
        </motion.div>
          ...
          {programs.map((program, index) => (
            <div
              ...
              className={`transition-all duration-500 ${
                activeProgram === index ? "opacity-100" : "opacity-0 hidden"
              }`}
            >
                  ...
                  <>
                    ...
                    <div className="mb-8">
                      <h4 className="text-xl font-bold text-gray-900 mb-4">
                        Kenapa Belajar di Codelab?
                      </h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {program.features?.map((feature, i) => (
                          <div
                            key={i}
                            className="flex items-start gap-3 p-4 bg-orange-50/50 rounded-xl"
                          >
                            <div
                              className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${feature.icon === "🎮" ? "bg-orange-100" : "bg-green-100"}`}
                            >
                    ...
                    <div className="mb-8">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {program.classes?.map((cls, i) => (
                          <div
                            key={i}
                            className="p-4 border border-gray-200 rounded-xl hover:border-orange-500 transition-colors flex items-start gap-3"
                          >
                    ...
                    <div className="mb-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {program.features?.map((feature, i) => (
                          <div
                            key={i}
                            className="text-center p-6 bg-orange-50/50 rounded-xl"
                          >
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-4">
                      {program.events?.map((event, i) => (
                        <div
                          key={i}
                          className="p-4 md:p-6 bg-orange-50/50 rounded-xl border-l-4 border-orange-500"
                        >
                          <div className="flex flex-col sm:flex-row items-start gap-4">
                            <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-orange-100 flex items-center justify-center shrink-0">
                              {EventIcons[event.icon] || (
                                <Lightbulb className="w-6 h-6 md:w-8 md:h-8 text-orange-500" />
                              )}
                            </div>
                            <div>
      ...
      <style jsx>{`
        ...
        .animate-spin-slow-alt {
          animation: spin-slow-alt 25s linear infinite;
        }
        .animate-shimmer {
